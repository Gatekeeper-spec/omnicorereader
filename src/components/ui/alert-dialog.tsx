  ...
  return (
    <AlertDialogPortal>
      ...
      <AlertDialogPrimitive.Content
        className={cn(
          "fixed top-1/2 left-1/2 z-50 grid w-[calc(100%-2rem)] max-w-md -translate-x-1/2 -translate-y-1/2 gap-4 rounded-xl bg-card p-6 paper-shadow",
          className,
        )}
        {...props}
      />
...
export function AlertDialogTitle({
  ...
  return (
    <AlertDialogPrimitive.Title className={cn("font-display text-xl font-medium", className)} {...props} />
  );
}
